...
BOOKING_CODES = 'Boekingscodes'
BOOKING_CODE_DESCRIPTION = 'Boekingscode omschrijving'
...
TEMPLATE_REALISATION_PER_BOOKING_CODE = 'Realisatie per boekingscode'
TOTAL = 'Totaal'
TOTALS = 'Totalen'
