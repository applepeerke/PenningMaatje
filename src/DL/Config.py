...
CF_IMPORT_PATH_BOOKING_CODES = 'CF_IMPORT_PATH_BOOKING_CODES'
...
TABLE_PROPERTIES = {
    ...
    Table.BookingCode: {
        CF_IMPORT_PATH: CF_IMPORT_PATH_BOOKING_CODES,
...
configDef = {
    ...
    CF_SHOW_BOOKING_CODE_AT_DESCRIPTION: ConfigItem(
        f'Toon {BOOKING_CODE} bij beschrijving', True,
    ...
    CF_IMPORT_PATH_BOOKING_CODES: ConfigItem(f'Pad naar {BOOKING_CODES_CSV}'),
